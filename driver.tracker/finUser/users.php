...
try {
    ...
    $sql = "SELECT user_id, driverId, username, firstName, lastName, email, status, created_at, last_login, userType, latitude, longitude, organization_name FROM fin_user $whereClause ORDER BY created_at DESC LIMIT ? OFFSET ?";
    if ($whereClause) {
