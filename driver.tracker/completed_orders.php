...
<head>
    ...
    <title>Completed Orders - <?php echo APP_NAME; ?></title>
            ...
            <main class="main-content">
                ...
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <p>View and manage all completed delivery orders</p>
                    </div>
                </div>
...
<div class="filter-group">
  ...
  <script>
        ...
        async function fetchOrders(fromDate, toDate, driverId = '') {
            ...
            try {
                let url = `https://erphub.ai/api/getCompletedOrders.php?fromDate=${fromDate}&toDate=${toDate}&page=${currentPage}&limit=20`;
